...
Serializers _$serializers = (new Serializers().toBuilder()
      ...
      ..add(GGetUsersData_users_data.serializer)
      ...
      ..addBuilderFactory(
          ...
          () => new ListBuilder<GGetUsersData_users_data>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(GSortOptions)]),
          () => new ListBuilder<GSortOptions>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(GOperatorOptions)]),
